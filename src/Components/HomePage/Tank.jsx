...
export const Tank = () => {
  ...
  const workingStaff = tanks.filter(
    (staffMember) => staffMember.tankStatus === "On use"
  );
  const notWorkingStaff = tanks.filter(
    (staffMember) => staffMember.tankStatus === "Not On use"
  );
      ...
      <div className="Staffs">
              ...
              <tr key={staffMember.tankCode} className="col" id="mainstate">
                ...
                <td className="iconmenu">
                  <IoEllipsisVerticalOutline
                    onClick={() => toggleSubMenu(staffMember.tankCode)}
                  />
        ...
        {selectedStaff && (
          <div className="viewStaff">
            ...
            <input
              type="text"
              value={selectedStaff.tankName}
              onChange={(e) =>
                setSelectedStaff({ ...selectedStaff, tankName: e.target.value })
              }
              readOnly={!editMode}
            />
            <br />
            <input type="text" value={selectedStaff.tankCode} readOnly />
            <br />
            <input
              type="text"
              value={selectedStaff.tankVolume}
              onChange={(e) =>
                setSelectedStaff({
                  ...selectedStaff,
            ...
            <br />
            <select
              value={selectedStaff.tankStatus}
              onChange={(e) =>
                setSelectedStaff({
                  ...selectedStaff,
            ...
            <select
              ...
              onChange={(e) =>
                setNewStaff({
                  ...newStaff,
                  product: { ...newStaff.product, productCode: e.target.value },
                })
              }
              disabled={!editMode}
            >
              {product.map((productMem) => (
                <option
                  key={productMem.productCode}
                  value={productMem.productCode}
                >
        ...
        {addingStaff && (
          <div className="addStaff">
            ...
            <input
              ...
              value={newStaff.tankName}
              onChange={(e) =>
                setNewStaff({ ...newStaff, tankName: e.target.value })
              }
            />
            <br />
            <input
              ...
              value={newStaff.tankCode}
              onChange={(e) =>
                setNewStaff({ ...newStaff, tankCode: e.target.value })
              }
            />
            <br />
            <input
              ...
              value={newStaff.tankVolume}
              onChange={(e) =>
                setNewStaff({ ...newStaff, tankVolume: e.target.value })
              }
            />
            <br />
            <select
              value={newStaff.tankStatus}
              onChange={(e) =>
                setNewStaff({ ...newStaff, tankStatus: e.target.value })
              }
            >
              <option value="On use">On use</option>
              <option value="Not On use">Not On use</option>
