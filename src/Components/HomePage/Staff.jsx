...
export const Staff = () => {
    ...
    const workingStaff = staff.filter(staffMember => staffMember.workingStatus === "IS WORKING");
    const notWorkingStaff = staff.filter(staffMember => staffMember.workingStatus === "ISN'T WORKING");
