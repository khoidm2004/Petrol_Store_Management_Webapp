...
export const Shift = () => {
  ...
  const [newShift, setNewShift] = useState({
    ...
    pumpList: {
      Pump1: {
        pumpName: "",
        pumpCode: 0,
        firstMeterReadingByMoney: 0,
        firstMeterReadingByLitre: 0,
      },
    },
    employeeList: {
  ...
  useEffect(() => {
    if (pumps.length > 0) {
      setNewShift((prevShift) => ({
        ...
        pumpList: {
          Pump1: {
            pumpName: pumps[0].pumpName,
            pumpCode: parseInt(pumps[0].pumpCode),
            firstMeterReadingByMoney: 0,
            firstMeterReadingByLitre: 0,
          },
        },
      ...
      setNewShift((prevShift) => ({
        ...
        productList: {
          Product1: {
            ...
            productPrice: parseInt(product[0].productPrice),
          },
        },
      }));
    }
  ...
  const handleAddProduct = () => {
    const newKey = `Product${
      Object.keys(selectedShift.productList).length + 1
    }`;
    setSelectedShift((prevShift) => ({
      ...prevShift,
      productList: {
          ...
          <>
            ...
            <div className="viewShift" value="">
              ...
              <div>
                <h5>
                  NHÂN VIÊN{" "}
                  <CgAddR className="pull_icon" onClick={handleAddEmployee} />
                </h5>
                <div className="Staff">
              ...
              <div className="Row">
                <div>
                  <h5>
                    MẶT HÀNG{" "}
                    <CgAddR className="pull_icon" onClick={handleAddProduct} />{" "}
                  </h5>
                  <div className="Staff">
                ...
                <div>
                  <h5>VÒI BƠM </h5>
                  <div className="Staff">
                    {Object.entries(selectedShift.pumpList).map(
                      ([key, pump]) => (
                        <div key={key} className="pump-item">
                                ...
                                pumpList: {
                                  ...
                                  [key]: {
                                    ...
                                    firstMeterReadingByMoney:
                                      selectedPump.firstMeterReadingByMoney,
                                    firstMeterReadingByLitre:
                                      selectedPump.firstMeterReadingByLitre,
                                  },
                                },
                              });
                            }}
                          >
                            <optgroup label="Mã Vòi Bơm - Tên Vòi Bơm">
                              {pumps.map((newpump) => (
                                <option
                                  key={newpump.pumpCode}
                                  value={newpump.pumpCode}
                                >
                          ...
                          <input
                            ...
                            value={pump.firstMeterReadingByLitre}
                            onChange={(e) =>
                              setSelectedShift({
                                ...selectedShift,
                                pumpList: {
                          ...
                          <input
                            ...
                            value={pump.firstMeterReadingByMoney}
                            onChange={(e) =>
                              setSelectedShift({
                                ...selectedShift,
                                pumpList: {
          ...
          <>
            ...
            <div className="addShift">
              ...
              <div>
                <h5>
                  MẶT HÀNG{" "}
                  <CgAddR className="pull_icon" onClick={handleAddNewProduct} />
                </h5>
                <div className="Staff">
