  ...
  return (
    <div className="page_account">
      <div className="profile_image_section">
        ...
        <button type="button" className="button_account" onClick={() => document.getElementById('fileInput').click()}>
          Change
        </button>
      </div>
      ...
      <div className="profile_info_section">
        <div className="profile_info">
          ...
          <input type="number" name="phoneNum" value={profile.phoneNum} onChange={handleChange} />
          
          <label htmlFor="storeName">QUẢN LÝ CỬA HÀNG</label>
          <input type="text" name="storeName" value={profile.storeName} onChange={handleChange} />
          
          <label htmlFor="pass">PASSWORD</label>
          <input type="password" name="pass" value={profile.pass} onChange={handleChange} />
        </div>
